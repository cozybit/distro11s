...
export CFLAGS="-I${STAGING}/usr/include -I${STAGING}/usr/include/x86_64-linux-gnu/ -I${STAGING}/usr/local/include/libnl3/ -I${STAGING}/usr/local/include -I${DISTRO11S_SRC}/src/kernel/include"
