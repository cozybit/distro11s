...
echo "cd /src/authsae; rm -rf build; mkdir build; cd build; export CFLAGS=\"${CFLAGS} -D_GNU_SOURCE\"; cmake -DCMAKE_INSTALL_PREFIX=/usr/local ../; make install;" > ${STAGING}/authsae.sh
